...
const Dashboard = () => {
	...
	const [currentyDeletingFile, setCurrentyDeletingFile] = useState<string | null>(null);
	...
	const { mutate: deleteFile } = trpc.deleteFile.useMutation({
		...
		onMutate: ({id}) => {
			setCurrentyDeletingFile(id);
		},
		onSettled: () => {
			setCurrentyDeletingFile(null);
		},
	});
